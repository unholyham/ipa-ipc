    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle {{ Route::currentRouteNamed(['proposal.create', 'profile.view']) ? 'active' : '' }}" href="#" id="actionDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            ACTIONS
          </a>
          <ul class="dropdown-menu" aria-labelledby="actionDropdown">
            <li><a class="dropdown-item" href="{{route('proposal.create')}}">Submit Proposal</a></li>
            <li><a class="dropdown-item" href="{{route('profile.view')}}">View Profile</a></li>
          </ul>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#">WHAT WE DO</a> {{-- Add active class logic if this route exists --}}
        </li>
        <li class="nav-item">
  ...
  <div class="row justify-content-between align-items-center bg-gradient" id="toolbar_nav">
    ...
    <div class="col-auto">
      <div class="row">
        <div class="col p-0">
          <div class="dropdown">
            <button type="button" class="btn btn-info nav_icon" style="font-size:15px;" id="notificationsDropdownToggle" data-bs-toggle="dropdown" aria-expanded="false"><i class="bi bi-bell-fill"></i>
