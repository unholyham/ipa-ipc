<div class="sticky-top">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('admin.users*') ? 'active' : '' }}"
                            href="{{ route('admin.users') }}">MANAGE ACCOUNTS</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('company*') ? 'active' : '' }}" href="{{ route('company.index') }}">MANAGE COMPANIES</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-between align-items-center bg-gradient" id="toolbar_nav">
            <div class="col-auto">
                <p class="m-0">Welcome, <a class="profileLink" href="{{ route('profile.view') }}"><span
                            class="text-warning lead"><strong>{{ Auth::user()->employeeName }}</strong></span></a></p>
            </div>
            <div class="col-auto">
                <div class="row">
                    <div class="col p-0">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="notificationsDropdownToggle"
                                id="notifications-list" style="max-height: 300px; overflow-y: auto; min-width: 300px;">
                                <li class="dropdown-header">Notifications</li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li class="text-center p-2 text-muted" id="notifications-loading">Loading...</li>
                                <li class="text-center p-2 text-muted" id="no-notifications" style="display: none;">No
                                ...
                                <li>
                                    <a class="dropdown-item text-center text-primary" href="#"
                                        id="mark-all-as-read-btn">Mark all as read</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col p-0">
                        <form method="post" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" class="btn btn-danger nav_icon" style="font-size:15px;"><i
