...
<head>
    ...
    <title>Applicant Registration Details</title>
    <!--Include Head CDN-->
...
<!--Include Navbar Based on Role-->
  ...
  <!--End of Include-->
    ...
    <div class="row border-top border-start border-end p-1 text-white mt-4 rounded-top" id="tp_table_info">
        <div class="col-md-3"><h6 class="subject">Name</h6></div>
        <div class="col-md-3"><h6>{{$user->name}}</h6></div>
    </div>
    <div class="row border-top border-start border-end p-1">
        <div class="col-md-3"><h6 class="subject">Email</h6></div>
        <div class="col-md-3"><h6>{{$user->email}}</h6></div>
    </div>
    <div class="row bg-light border-top border-start border-end p-1">
        <div class="col-md-3"><h6 class="subject">Role</h6></div>
        <div class="col-md-3"><h6>{{$user->role}}</h6></div>
    </div>
    ...
    <div class="row bg-light border p-1">
        ...
        <div class="col-md-3"><h6>{{$user->remarks}}</h6></div>
    </div>
    @endif
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Are you sure you want to <strong>"Approve"</strong> this user's registration application?
                <br><br>
                This action will notify the user that their application has been approved.
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                <button type="button" class="btn btn-success" onclick="approveRegistration()" data-bs-dismiss="modal">Agree</button>
            </div>
        </div>
    </div>
</div>
