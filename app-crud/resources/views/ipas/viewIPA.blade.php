...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="{{route('product.index')}}">VENDORS</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{route('product.create')}}">REGISTER</a>
        </li>
        <li class="nav-item">
  ...
  <h1>Product</h1>
    ...
    <div>
        ...
        @foreach($products as $product)
            <tr>
                <td><a href="{{route('product.edit', ['product' => $product])}}" class="editProductLink">{{$product->name}}</a></td>
                <td>{{$product->qty}}</td>
                <td>{{$product->price}}</td>
