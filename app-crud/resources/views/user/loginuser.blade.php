                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('post.login') }}">
                            ...
                            <button type="submit" class="btn btn-primary w-100" data-bs-toggle="tooltip"
                                data-bs-placement="bottom" data-bs-custom-class="login-button-tooltip"
                                data-bs-title="Login">Login</button>
                        </form>
                    </div>
                    <p class="text-center">Don't Have an Account? <a href="{{ route('register') }}">Register Account</a>
                    </p>
